...
نسخة الموقع مرتبطة بـFirebase، وتجري تهيئة النشر على Cloudflare Pages من مستودع Swiitchom/SWITCH-WEBSITE. نجح اختبار مسار Cloudflare محليًا مع Firestore الحقيقية؛ النشر العام وربط GitHub في Cloudflare لم يكتمل بعد.
...
- إعداد البناء: Framework preset = None، الفرع main، أمر البناء npm test، مجلد الإخراج public، Node.js 22. أنشئ المشروع باتصال GitHub منذ البداية لتفعيل النشر التلقائي.
...
## سجل الربط السابق في 6 سبتمبر 2026
